...
export const CHANNEL_REGISTRY: ChannelDef[] = [
  ...
  },
  {
    ...
    label: "Servo Output",
    fields: [
      { key: "ch1", label: "Out 1", unit: "µs", extract: (d) => chanAt(d.servos, 0) },
      { key: "ch2", label: "Out 2", unit: "µs", extract: (d) => chanAt(d.servos, 1) },
      { key: "ch3", label: "Out 3", unit: "µs", extract: (d) => chanAt(d.servos, 2) },
      { key: "ch4", label: "Out 4", unit: "µs", extract: (d) => chanAt(d.servos, 3) },
      { key: "ch5", label: "Out 5", unit: "µs", extract: (d) => chanAt(d.servos, 4) },
      { key: "ch6", label: "Out 6", unit: "µs", extract: (d) => chanAt(d.servos, 5) },
      { key: "ch7", label: "Out 7", unit: "µs", extract: (d) => chanAt(d.servos, 6) },
      { key: "ch8", label: "Out 8", unit: "µs", extract: (d) => chanAt(d.servos, 7) },
    ],
  },
  {
    channel: "ekf",
