 ...
 *
 * Children always render and stay fully interactive. When the vehicle is
 * armed, a non-blocking warning banner pins to the top of the panel scroll
 * area. Nothing here blocks a write: the write guard is the save-time
 * confirmation dialog opened by `usePanelParams.saveAllToRam()`.
 */
export function ArmedWarningBanner({
  children,
  className,
}: {
