 ...
 * @description Text draft for a numeric field that follows its source value.
 ...
 * later blur never writes a stale draft back.
...
export function useSyncedDraft(value: number | undefined): [string, Dispatch<SetStateAction<string>>] {
