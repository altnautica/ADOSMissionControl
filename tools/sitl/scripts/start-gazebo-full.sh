...
cd "$SITL_DIR"
npx tsx src/index.ts --scenario terrain-gazebo --no-dashboard > /tmp/gazebo-sitl.log 2>&1 &
PID2=$!
...
for world_name in ados_terrain_real ados_multi_copter ados_urban ados_agriculture; do
